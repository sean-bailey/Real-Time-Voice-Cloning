...
def getModulePath(modulename):
    ...
    os.path.dirname(os.path.abspath(inspect.getfile(
        inspect.currentframe())))  # this should be the location of the currently executing file -- which means if placed in the right location could tell the location of everything else.
